...
async function fetchCovidData() {
  ...
  while (i < statecount - 2) {
    $reports.append(
      '<tr scope="row"><td>' +
        reports["statewise"][i]["state"] +
        "</td><td>" +
        reports["statewise"][i]["confirmed"] +
        "</td><td>" +
        reports["statewise"][i]["active"] +
        "</td><td>" +
        reports["statewise"][i]["recovered"] +
        "</td><td>" +
        reports["statewise"][i]["deaths"] +
        "</td><td>" +
        reports["statewise"][i]["lastupdatedtime"] +
        "</td></tr>"
    );
    i++;
  }
